...
void displayMenu() {
    ...
    cout << "14. Trier les Livres par Auteur \n";
    cout << "15. Trier les Livres par Titre \n";
    cout << "0.  Quitter\n";
    cout << "======================================================\n";
    ...
    while (running) {
        ...
        switch (choice) {
            ...
            case 2: { // Remove Book
                ...
                cout << "Souhaitez-vous vraiment supprimer le livre avec l'ISBN  :" << isbn << " ? (o/n) : ";
                char confirm;        
                cin >> confirm;
